...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      {/* Employee Routes */}
      <Route path="/employee" element={<ProtectedRoute allowedRoles={['employee']}><DashboardLayout role="employee" /></ProtectedRoute>}>
        ...
        <Route path="faqs" element={<Placeholder title="Knowledge Base" />} />
