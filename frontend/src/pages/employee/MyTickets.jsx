            ...
            <Card className="border-0 shadow-sm">
                <Card.Body>
                    <Row className="g-2 mb-3 align-items-end">
                        <Col md={4}>
                            <Form.Control placeholder="Search by ticket # or title..." value={search} onChange={(e) => setSearch(e.target.value)} />
                        </Col>
                        <Col md={2}>
                    ...
                    tickets.length === 0 ? (
                        <div className="text-center py-5 text-muted">
                            ...
                            <h5 className="mt-3">{hasActiveFilters ? 'No tickets match your filters' : 'No tickets found'}</h5>
                            <p>{hasActiveFilters ? 'Try adjusting your search or filter criteria.' : 'You haven\'t raised any support requests yet.'}</p>
                            {hasActiveFilters && (
                        ...
                        <Table hover responsive className="align-middle" style={{ fontSize: '0.9rem' }}>
                            <thead className="table-light">
                                <tr>
                                    <th>Ticket #</th><th>Title</th><th>Category</th><th>Priority</th><th>Technician</th><th>Status</th><th>SLA</th><th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                {tickets.map(t => (
