...
/* ══════════════════════════════════════════════
   GLOBAL ANIMATION + LOGIN COLOR THEME
══════════════════════════════════════════════ */
...
const GlobalStyles = () => (
  <style>{`
    ...
    .technician-dashboard {
      ...
      --it-primary-light: #3b82f6;

      --it-cyan: #06b6d4;
      --it-sky: #38bdf8;

      --it-success: #10b981;
      --it-success-dark: #059669;
    ...
    .kpi-card {
      ...
      border:
        1px solid
        rgba(226, 232, 240, 0.8) !important;
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 6px 16px -6px rgba(37,99,235,0.25)",
        }}
      >
        {icon}
      </div>
...
const TechnicianDashboard = () => {
  ...
  const kpiCards = [
...

    {
      ...
      route:
        "/technician/tickets?status=closed",
    },
...

    {
      ...
      route:
        "/technician/tickets?status=reopened",
    },
  ];
                  ...
                  >
                    ...
                    <circle
                      ...
                      style={{
                        ...
                        filter:
                          `drop-shadow(0 0 6px ${slaColor}55)`,
                      }}
                    />
