...
const EmployeeSignup = () => {
  ...
  // ===== NEW: holds the backend-generated Employee ID (e.g. EMP-000007) =====
  ...
  const handleSubmit = async (e) => {
    ...
    // No employee_id here — the backend generates it automatically.
    const submitData = {
    ...
    try {
      ...
      const response = await authService.employeeSignup(submitData);
      setGeneratedId(response?.data?.data?.employee_id || null);
      setSubmitted(true);
    } catch (err) {
      setFieldErrors({});
      setError('');
          ...
          <div className="success-card auth-animate-in">
            <Card className="auth-card">
              <Card.Body className="auth-card-body py-5">
                ...
                {/* ===== NEW: prominent backend-generated Employee ID with copy ===== */}
                {generatedId && (
                  <div
