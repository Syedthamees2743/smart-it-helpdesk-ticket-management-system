...
from .models import User, EmployeeProfile, TechnicianProfile, AccountActivation, IDCounter
...
class EmployeeProfileAdmin(admin.ModelAdmin):
    ...
    # ===== CHANGED: ID generated by backend — not editable here
...
class TechnicianProfileAdmin(admin.ModelAdmin):
    ...
    # ===== CHANGED: ID generated by backend — not editable here
    readonly_fields = ('created_at', 'technician_id')
...
@admin.register(IDCounter)
class IDCounterAdmin(admin.ModelAdmin):
    """View-only admin page for the ID counters."""
